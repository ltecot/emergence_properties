...
class Equilibrium_Propegation_Network(nn.Module):
    def __init__(self, input_size, output_size, epsilon, alpha, learning_rate, name="equil_prop_baseline"):
    ...
    def predict_and_measure(self, ground_truth):
        ...
        y_prediction = torch.argmax(self.layers[-1], axis=1)
        return y_prediction, E, C
    ...
    def optimize(self, input, n_iterations, reset_states=False, beta=0, ground_truth=None):
